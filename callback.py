...
butt3 = Button(root, text="button 3", command=changeLabel3)

changerandom = Button(root, text="change random", command=changeRandom)

Label1 = Label(root, text="Unchanged1")
Label2 = Label(root, text="Unchanged2")
Label3 = Label(root, text="Unchanged3")
...
changerandom.grid(row=4, column=1)
